...
declare namespace XEUtils {
  ...
  */
   ...
   * @param rules 自定义计算规则
   */
  export function getDateDiff(startDate: string | Date | number, endDate: string | Date | number, rules?: GetDateDiffRules): DateDiffResult;
   ...
   * Cookie 操作函数
   */
  export function CookieFunc(): cookie;

  /**
   * Cookie 操作函数
   * @param name 键/数组/对象
   */
  export function CookieFunc(name: string): cookie;
   ...
   * @param value 值
   */
  export function CookieFunc(name: string, value: any): cookie;
   ...
   * @param options 可选参数
   */
  export function CookieFunc(name: string, value: any, options: CookieOptions): cookie;
